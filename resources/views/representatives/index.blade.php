@extends('layouts.app')
@include('partials.create-representative-modal')
@include('partials.update-representative-modal')
@section('content')
<div class="card mb-2">
    ...
    <div id="collapseFiltros" class="collapse show">
        <div class="card-body">
            <form id="filters" method="GET" action="{{ route('representatives.index') }}" autocomplete="off" class="row g-3">
                ...
                <div class="col-12 text-end">
                    ...
                    <a href="{{ route('representatives.index') }}" class="btn btn-secondary">Limpar</a>
                </div>
            </form>
        </div>
    </div>
...
<div class="card mb-2">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#createModal">Cadastrar Representante</button>
    </div>
    <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        $('#createForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    let message = 'Erro ao cadastrar representante.';
        ...
        $(document).on('click', '.btn-edit', async function() {
            ...
            try {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Erro',
                    text: 'Erro ao buscar dados do representante.'
                });
            }
        });
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    let message = 'Erro ao atualizar representante.';
                ...
                $.ajax({
                    ...
                    success: function() {
                        Swal.fire({
                            icon: 'success',
                            title: 'Excluído!',
                            text: 'O representante foi excluído com sucesso.',
                            timer: 1500,
                            showConfirmButton: false
                        });
                    ...
                    error: function(xhr) {
                        let message = 'Erro ao excluir o representante.';
    ...
    function getStatesFromClients() {
        $.ajax({
            url: '/api/v1/representatives/get-states-from-representatives',
            method: 'GET',
